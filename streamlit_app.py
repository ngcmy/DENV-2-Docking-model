...
def display_denv2_docking_procedure():
    ...
    st.image("https://github.com/ngcmy/DENV-2-Docking-model/blob/master/App.png", use_column_width=True)
...
def main():
    ...
    #st.sidebar.image("https://github.com/ngcmy/DENV-2-Docking-model/DENV-2-Docking-model/blob/master/App.png", width=300)
