...
def display_denv2_docking_procedure():
    ...
    st.image("https://github.com/ngcmy/DENV-2-Docking-model/blob/5028d1dfd2bedaab191e621f5581deaa713970a5/App.png", use_column_width=True)
...
def main():
    ...
    #st.sidebar.image("https://github.com/ngcmy/DENV-2-Docking-model/blob/5028d1dfd2bedaab191e621f5581deaa713970a5/App.png", width=300)
